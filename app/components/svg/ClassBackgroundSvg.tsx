...
export default function ClassBackgroundSvg(props: SvgProps & Props) {
  ...
  return (
    <Svg viewBox="0 0 400 100" {...props} pointerEvents="none">
      <Rect x="0" y="0" width="400" height="100" fill="#3083FF" rx="6" pointerEvents="none"/>
      <Path d={path} rotation={props.pathRotation} origin={`${27 + props.xOffset}, ${2 + props.yOffset}`} fill="#CC0000" pointerEvents="none"/>
    </Svg>
  )
}